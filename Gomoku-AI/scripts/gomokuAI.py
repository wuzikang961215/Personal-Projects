...
class GomokuAI:
    ...
    def __init__(self, board):
        ...
        # score: situation
        self.scores =  {5: ['001010', '010100', '00100', '010000', '000010'],  # Reduced scores for less impactful moves
                        50: ['011200', '001120', '002110', '021100'],  # Slightly reduced for non-critical formations
                        200: ['001100', '011000', '000110', '001112', '010112', '011012', '211100', '211010'],  # Increased importance
                        5000: ['001110', '011100', '010110', '011010'],  # Key attack formations
                        100000000: ['011110'],  # Almost winning situation
                        1000000000: ['11111']}  # Winning situation
        self.enemyscores = {10: ['002020', '020200', '00200', '020000', '000020'],  # Reduced scores for less impactful moves
                            100: ['002210', '020221', '022021', '122200', '122020', '002200', '022000', '000220'],  # Slightly reduced for non-critical formations
                            2000: ['002220', '022200', '020220', '022020'],  # Important blocking moves
                            5000000: ['022222'],  # Almost losing situation (must block)
                            800000000: ['22222']}  # Losing situation
        ...
        for i in range(len(self.board)):
            for j in range(len(self.board[0])):
                if self.board[i][j] == EMPTY:
                    ...
                    # predict 7 future moves
                    newScore = self.dfs(i, j, 7, discovered, dp)
